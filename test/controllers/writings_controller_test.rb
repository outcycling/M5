...
class WritingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writing" do
    assert_difference('Writing.count') do
      post writings_url, params: { writing: { body: @writing.body, headline: @writing.headline, user_id: @writing.user_id } }
    end
  ...
  test "should update writing" do
    patch writing_url(@writing), params: { writing: { body: @writing.body, headline: @writing.headline, user_id: @writing.user_id } }
