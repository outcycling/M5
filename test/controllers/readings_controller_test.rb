...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { body: @reading.body, headline: @reading.headline } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { body: @reading.body, headline: @reading.headline } }
