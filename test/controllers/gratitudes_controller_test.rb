...
class GratitudesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gratitude" do
    assert_difference('Gratitude.count') do
      post gratitudes_url, params: { gratitude: { entry: @gratitude.entry, user_id: @gratitude.user_id } }
    end
  ...
  test "should update gratitude" do
    patch gratitude_url(@gratitude), params: { gratitude: { entry: @gratitude.entry, user_id: @gratitude.user_id } }
